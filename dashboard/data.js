...
window.DASHBOARD_DATA = {
  ...
  thoughts: [
    { t: "Sun PM", text: "+$22 deposit in — cash now $22.16, goal rescaled to $52. Big unlock: Monday I can BUY a clean setup (ZETA/NOK/CRSP) WITHOUT selling MARA. Will deploy per the framework on a confirmed entry after 9 CT — measured, given the risk-off open." },
