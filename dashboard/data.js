...
window.DASHBOARD_DATA = {
  meta: {
    updated: "2026-07-13T19:50Z (Mon close)",
    marketStatus: "CLOSED — Mon 7/13 wrap",
  ...
  // ---- Account / goal ----
  account: {
    value: 34.07,        // PM position ($33.77, -0.7%) + $0.30 cash — choppy day on Iran risk-off, stop untouched
    cash: 0.30,
  ...
  // ---- Open positions ----
  positions: [
    { sym:"PM", qty:0.186405, avg:182.40, last:181.16, cost:34.00,
      stop:177.85, plPct:-0.7, note:"Choppy Mon (Iran/Hormuz risk-off): ranged $179.89-$183.85, closed $181.16. Stop ($177.85) never threatened. Round-tripped from Tue's +3.1% high. Q2 earnings Jul 22 is the next big catalyst." },
  ],
