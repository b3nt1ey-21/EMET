...
window.DASHBOARD_DATA = {
  ...
  // ---- Account / goal ----
  account: {
    value: 37.06,        // ZETA position + cash
    cash: 18.62,
    buyingPower: 18.62,  // fully settled (MARA cleared T+1)
  ...
  watching: [
    { sym:"SMCI", action:"BUY",  level:33.00, note:"pulling back to ~$33 entry zone — buy if it holds, BP $18.62 ready" },
  ...
  // ---- Open positions ----
  positions: [
    { symbol:"ZETA", shares:0.941422, cost:19.12, last:19.83,
      stop:18.76, note:"AI software · +3.7% green · recovered above 50-DMA · stop raised to $18.76" },
  ],
