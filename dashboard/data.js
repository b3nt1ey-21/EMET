...
window.DASHBOARD_DATA = {
  ...
  bias: {
    call: "TUG-OF-WAR",
    detail: "Iran peace deal (risk-ON) vs hawkish Fed + hot inflation (risk-OFF). Constructive but cautious.",
  ...
  alerts: [
    { t:"Sun", tag:"NEWS", text:"Iran–US peace deal signed; Hormuz blockade lifted → risk-ON for Mon open." },
